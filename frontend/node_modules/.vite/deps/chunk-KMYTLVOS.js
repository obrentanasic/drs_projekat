...
import {
  ...
  major,
  useFormControl
} from "./chunk-VSU4XX3W.js";
import {
  createSvgIcon
} from "./chunk-JOJYBXCS.js";
import {
  alpha,
  useMediaQuery,
  useTheme,
  useThemeProps
} from "./chunk-YAPFDCQX.js";
import {
  CacheProvider,
  Global,
  StyleSheet,
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime14.jsxs)(React47.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime14.jsxs)(React47.Fragment, {
  children: [(0, import_jsx_runtime14.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime14.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function PickersSection(props) {
  ...
  const sectionContentRef = React48.useRef(null);
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React55.useLayoutEffect : React55.useEffect;
...
var PickersTextField = React71.forwardRef(function PickersTextField2(inProps, ref) {
  ...
  const ownerState = React71.useMemo(() => _extends({}, fieldOwnerState, {
  ...
  return (0, import_jsx_runtime32.jsx)(PickerTextFieldOwnerStateContext.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsxs)(PickersTextFieldRoot, _extends({
      ...
      children: [label != null && label !== "" && (0, import_jsx_runtime32.jsx)(InputLabel_default, _extends({
        ...
        "data-active-range-position": dataActiveRangePosition
      }, inputAdditionalProps, InputProps)), helperText && (0, import_jsx_runtime32.jsx)(FormHelperText_default, _extends({
        id: helperTextId
      }, FormHelperTextProps, {
        children: helperText
      }))]
...
var PickerFieldUIContext = React72.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
...
function PickerFieldUI(props) {
  ...
  const translations = usePickerTranslations();
  const pickerContext = useNullablePickerContext();
  const pickerFieldUIContext = React72.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!(textFieldInputProps == null ? void 0 : textFieldInputProps.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    additionalTextFieldInputProps.startAdornment = (0, import_jsx_runtime33.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
  ...
  if (!(textFieldInputProps == null ? void 0 : textFieldInputProps.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime33.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
  ...
  if (!(additionalTextFieldInputProps == null ? void 0 : additionalTextFieldInputProps.endAdornment) && !(additionalTextFieldInputProps == null ? void 0 : additionalTextFieldInputProps.startAdornment) && pickerFieldUIContext.slots.inputAdornment) {
    additionalTextFieldInputProps.endAdornment = (0, import_jsx_runtime33.jsx)(InputAdornment, _extends({}, endInputAdornmentProps));
  }
...
var DateField = React73.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React75.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
var PickersDayRaw = React78.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React78.memo(PickersDayRaw);
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime37.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React79.cloneElement(element, {
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React80.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const isOutsideCurrentMonth = React80.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
  ...
  const isFirstVisibleCell = React80.useMemo(() => {
  ...
  const isLastVisibleCell = React80.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React80.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React80.useMemo(() => React80.createRef(), [transitionKey]);
  const weeksToDisplay = React80.useMemo(() => {
...
var MonthCalendarButton = React81.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var MonthCalendar = React82.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React82.useMemo(() => adapter.getMonth(now), [adapter, now]);
  const selectedMonth = React82.useMemo(() => {
    if (value != null) {
      return adapter.getMonth(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedMonth, setFocusedMonth] = React82.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  const isMonthDisabled = React82.useCallback((dateToValidate) => {
...
var YearCalendarButton = React83.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React84.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const referenceDate = React84.useMemo(
    () => singleItemValueManager.getInitialReferenceValue({
      value,
      adapter,
      props,
  ...
  const todayYear = React84.useMemo(() => adapter.getYear(now), [adapter, now]);
  const selectedYear = React84.useMemo(() => {
    if (value != null) {
      return adapter.getYear(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedYear, setFocusedYear] = React84.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React84.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React84.useRef(null);
...
var PickersArrowSwitcher = React85.forwardRef(function PickersArrowSwitcher2(inProps, ref) {
  const isRtl = useRtl();
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersArrowSwitcher"
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React86.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
  const meridiemMode = getMeridiem(cleanDate, adapter);
  const handleMeridiemChange = React86.useCallback((mode) => {
...
var PickersCalendarHeader = React87.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React88.forwardRef(function DateCalendar2(inProps, ref) {
  const adapter = usePickerAdapter();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React88.useRef(view);
  React88.useEffect(() => {
  ...
  const selectedDays = React88.useMemo(() => [value], [value]);
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KMYTLVOS.js.map
